...
const Login = ({navigation}: any) => {
  ...
  const login = async () => {
    ...
    // }
    try {
      const refreshJson = await fetch('http://10.0.1.19:3000/user/login', {
        method: 'POST',
        headers: {
      ...
      const userJson = await fetch('http://10.0.1.19:3000/user/accessToken', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
      ...
      if (user.encryptedKey) {
        ...
        const updateJson = await fetch('http://10.0.1.19:3000/user/update', {
          method: 'POST',
          headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json',
  ...
  return (
    <>
      ...
      <SafeAreaView style={styles.scrollView}>
        <ImageBackground source={require('./Login.jpg')} style={styles.bg}>
